...
Vì cả GCP và AWS cần 24h để prepare cost và usage data của người dùng mới, nên e chưa thể gửi ảnh billing dashboard đã có cost spent từ cả hai nền tảng.
